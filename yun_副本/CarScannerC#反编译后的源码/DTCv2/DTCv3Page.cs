...
namespace CarScannerXamarinForms.DTCv2
{
	...
	[XamlCompilation(2)]
	[XamlFilePath("DTCv2\\DTCv3Page.xaml")]
	public class DTCv3Page : ContentPage, IDTCvXPage
	{
		// Token: 0x060034A1 RID: 13473 RVA: 0x00255380 File Offset: 0x00253580
		public DTCv3Page()
		{
		...
		// Token: 0x060034A2 RID: 13474 RVA: 0x002553F0 File Offset: 0x002535F0
		...
		// Token: 0x060034A3 RID: 13475 RVA: 0x00255433 File Offset: 0x00253633
		...
		// Token: 0x060034A4 RID: 13476 RVA: 0x000027D4 File Offset: 0x000009D4
		private void LvDTCs_ItemSelected(object sender, SelectedItemChangedEventArgs e)
		{
		}

		// Token: 0x060034A5 RID: 13477 RVA: 0x0024A89F File Offset: 0x00248A9F
		...
		// Token: 0x060034A6 RID: 13478 RVA: 0x0025546D File Offset: 0x0025366D
		...
		// Token: 0x060034A7 RID: 13479 RVA: 0x00255484 File Offset: 0x00253684
		...
		// Token: 0x060034A8 RID: 13480 RVA: 0x0024A913 File Offset: 0x00248B13
		...
		// Token: 0x060034A9 RID: 13481 RVA: 0x002554C4 File Offset: 0x002536C4
		...
		// Token: 0x060034AA RID: 13482 RVA: 0x002554FC File Offset: 0x002536FC
		private void CustomCell_Tapped(object sender, EventArgs e)
		{
			CellBase cellBase = sender as CellBase;
			if (cellBase != null)
			{
				DTCItemV2 dtcitemV = cellBase.BindingContext as DTCItemV2;
				if (dtcitemV != null)
				{
		...
		// Token: 0x060034AB RID: 13483 RVA: 0x00255530 File Offset: 0x00253730
		[GeneratedCode("Xamarin.Forms.Build.Tasks.XamlG", "2.0.0.0")]
		private void InitializeComponent()
		{
			if (ResourceLoader.IsEnabled && ResourceLoader.CanProvideContentFor(new ResourceLoader.ResourceLoadingQuery
			{
				AssemblyName = typeof(DTCv3Page).GetTypeInfo().Assembly.GetName(),
				ResourcePath = "DTCv2/DTCv3Page.xaml",
				Instance = this
			}))
			{
			...
			Translate translate;
			VisualDiagnostics.RegisterSourceInfo(translate = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 15, 5);
			DynamicResourceExtension dynamicResourceExtension;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 18, 5);
			DTCStatusCollectionToStringConverter dtcstatusCollectionToStringConverter;
			VisualDiagnostics.RegisterSourceInfo(dtcstatusCollectionToStringConverter = new DTCStatusCollectionToStringConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 23, 14);
			DTCDescriptionCollectionToStringConverter dtcdescriptionCollectionToStringConverter;
			VisualDiagnostics.RegisterSourceInfo(dtcdescriptionCollectionToStringConverter = new DTCDescriptionCollectionToStringConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 24, 14);
			DTCCodeToStringConverter dtccodeToStringConverter;
			VisualDiagnostics.RegisterSourceInfo(dtccodeToStringConverter = new DTCCodeToStringConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 25, 14);
			EmptyStringToFalseConverter emptyStringToFalseConverter;
			VisualDiagnostics.RegisterSourceInfo(emptyStringToFalseConverter = new EmptyStringToFalseConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 26, 14);
			BoolToNegativeConverter boolToNegativeConverter;
			VisualDiagnostics.RegisterSourceInfo(boolToNegativeConverter = new BoolToNegativeConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 27, 14);
			TrueToRedColorConverter trueToRedColorConverter;
			VisualDiagnostics.RegisterSourceInfo(trueToRedColorConverter = new TrueToRedColorConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 28, 14);
			FormatStringConverter formatStringConverter;
			VisualDiagnostics.RegisterSourceInfo(formatStringConverter = new FormatStringConverter(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 29, 14);
			ResourceDictionary resourceDictionary;
			VisualDiagnostics.RegisterSourceInfo(resourceDictionary = new ResourceDictionary(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 22, 10);
			ColumnDefinition columnDefinition;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 35, 18);
			ColumnDefinition columnDefinition2;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition2 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 37, 18);
			ColumnDefinition columnDefinition3;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition3 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 39, 18);
			ColumnDefinition columnDefinition4;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition4 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 40, 18);
			BindingExtension bindingExtension;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 44, 17);
			DynamicResourceExtension dynamicResourceExtension2;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension2 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 46, 17);
			Translate translate2;
			VisualDiagnostics.RegisterSourceInfo(translate2 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 47, 17);
			LinkButton linkButton;
			VisualDiagnostics.RegisterSourceInfo(linkButton = new LinkButton(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 42, 14);
			DynamicResourceExtension dynamicResourceExtension3;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension3 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 53, 17);
			Translate translate3;
			VisualDiagnostics.RegisterSourceInfo(translate3 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 54, 17);
			NonScalableLabel nonScalableLabel;
			VisualDiagnostics.RegisterSourceInfo(nonScalableLabel = new NonScalableLabel(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 48, 14);
			BindingExtension bindingExtension2;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension2 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 61, 17);
			DynamicResourceExtension dynamicResourceExtension4;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension4 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 62, 17);
			BindingExtension bindingExtension3;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension3 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 64, 43);
			TapGestureRecognizer tapGestureRecognizer;
			VisualDiagnostics.RegisterSourceInfo(tapGestureRecognizer = new TapGestureRecognizer(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 64, 22);
			Image image;
			VisualDiagnostics.RegisterSourceInfo(image = new Image(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 56, 14);
			BindingExtension bindingExtension4;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension4 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 72, 17);
			DynamicResourceExtension dynamicResourceExtension5;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension5 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 73, 17);
			BindingExtension bindingExtension5;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension5 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 75, 43);
			TapGestureRecognizer tapGestureRecognizer2;
			VisualDiagnostics.RegisterSourceInfo(tapGestureRecognizer2 = new TapGestureRecognizer(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 75, 22);
			Image image2;
			VisualDiagnostics.RegisterSourceInfo(image2 = new Image(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 67, 14);
			BindingExtension bindingExtension6;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension6 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 81, 17);
			DynamicResourceExtension dynamicResourceExtension6;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension6 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 82, 17);
			BindingExtension bindingExtension7;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension7 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 84, 43);
			TapGestureRecognizer tapGestureRecognizer3;
			VisualDiagnostics.RegisterSourceInfo(tapGestureRecognizer3 = new TapGestureRecognizer(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 84, 22);
			Image image3;
			VisualDiagnostics.RegisterSourceInfo(image3 = new Image(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 78, 14);
			Grid grid;
			VisualDiagnostics.RegisterSourceInfo(grid = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 33, 10);
			RowDefinition rowDefinition;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 95, 18);
			RowDefinition rowDefinition2;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition2 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 96, 18);
			BindingExtension bindingExtension8;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension8 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 101, 17);
			RowDefinition rowDefinition3;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition3 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 103, 22);
			RowDefinition rowDefinition4;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition4 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 105, 22);
			RowDefinition rowDefinition5;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition5 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 107, 22);
			RowDefinition rowDefinition6;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition6 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 109, 22);
			BindingExtension bindingExtension9;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension9 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 121, 21);
			DataTemplate dataTemplate;
			VisualDiagnostics.RegisterSourceInfo(dataTemplate = new DataTemplate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 123, 26);
			DynamicResourceExtension dynamicResourceExtension7;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension7 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 137, 33);
			Translate translate4;
			VisualDiagnostics.RegisterSourceInfo(translate4 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 140, 33);
			Label label;
			VisualDiagnostics.RegisterSourceInfo(label = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 135, 30);
			DynamicResourceExtension dynamicResourceExtension8;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension8 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 143, 33);
			StaticResourceExtension staticResourceExtension;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 146, 33);
			BindingExtension bindingExtension10;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension10 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 146, 33);
			Translate translate5;
			VisualDiagnostics.RegisterSourceInfo(translate5 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 147, 33);
			Label label2;
			VisualDiagnostics.RegisterSourceInfo(label2 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 141, 30);
			BindingExtension bindingExtension11;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension11 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 152, 33);
			BindingExtension bindingExtension12;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension12 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 154, 33);
			DynamicResourceExtension dynamicResourceExtension9;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension9 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 158, 37);
			DynamicResourceExtension dynamicResourceExtension10;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension10 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 159, 37);
			Translate translate6;
			VisualDiagnostics.RegisterSourceInfo(translate6 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 160, 37);
			StaticResourceExtension staticResourceExtension2;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension2 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 161, 37);
			RadioButtonWithColor radioButtonWithColor;
			VisualDiagnostics.RegisterSourceInfo(radioButtonWithColor = new RadioButtonWithColor(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 155, 34);
			DynamicResourceExtension dynamicResourceExtension11;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension11 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 165, 37);
			DynamicResourceExtension dynamicResourceExtension12;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension12 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 166, 37);
			Translate translate7;
			VisualDiagnostics.RegisterSourceInfo(translate7 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 167, 37);
			StaticResourceExtension staticResourceExtension3;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension3 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 168, 37);
			RadioButtonWithColor radioButtonWithColor2;
			VisualDiagnostics.RegisterSourceInfo(radioButtonWithColor2 = new RadioButtonWithColor(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 162, 34);
			Grid grid2;
			VisualDiagnostics.RegisterSourceInfo(grid2 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 149, 30);
			StackLayout stackLayout;
			VisualDiagnostics.RegisterSourceInfo(stackLayout = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 134, 26);
			Translate translate8;
			VisualDiagnostics.RegisterSourceInfo(translate8 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 178, 58);
			Label label3;
			VisualDiagnostics.RegisterSourceInfo(label3 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 178, 30);
			SharedSettings sharedSettings;
			VisualDiagnostics.RegisterSourceInfo(sharedSettings = SharedSettings.Current, new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 183, 33);
			BindingExtension bindingExtension13;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension13 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 184, 33);
			Translate translate9;
			VisualDiagnostics.RegisterSourceInfo(translate9 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 185, 33);
			LabelSwitch labelSwitch;
			VisualDiagnostics.RegisterSourceInfo(labelSwitch = new LabelSwitch(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 179, 30);
			SharedSettings sharedSettings2;
			VisualDiagnostics.RegisterSourceInfo(sharedSettings2 = SharedSettings.Current, new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 190, 33);
			BindingExtension bindingExtension14;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension14 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 191, 33);
			Translate translate10;
			VisualDiagnostics.RegisterSourceInfo(translate10 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 192, 33);
			LabelSwitch labelSwitch2;
			VisualDiagnostics.RegisterSourceInfo(labelSwitch2 = new LabelSwitch(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 186, 30);
			Translate translate11;
			VisualDiagnostics.RegisterSourceInfo(translate11 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 196, 33);
			Button button;
			VisualDiagnostics.RegisterSourceInfo(button = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 193, 30);
			StackLayout stackLayout2;
			VisualDiagnostics.RegisterSourceInfo(stackLayout2 = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 176, 26);
			ListView listView;
			VisualDiagnostics.RegisterSourceInfo(listView = new ListView(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 114, 18);
			ColumnDefinition columnDefinition5;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition5 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 202, 26);
			ColumnDefinition columnDefinition6;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition6 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 203, 26);
			BindingExtension bindingExtension15;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension15 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 208, 25);
			Translate translate12;
			VisualDiagnostics.RegisterSourceInfo(translate12 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 210, 25);
			Button button2;
			VisualDiagnostics.RegisterSourceInfo(button2 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 205, 22);
			BindingExtension bindingExtension16;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension16 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 214, 25);
			Translate translate13;
			VisualDiagnostics.RegisterSourceInfo(translate13 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 216, 25);
			Button button3;
			VisualDiagnostics.RegisterSourceInfo(button3 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 211, 22);
			Grid grid3;
			VisualDiagnostics.RegisterSourceInfo(grid3 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 200, 18);
			BindingExtension bindingExtension17;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension17 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 222, 21);
			BindingExtension bindingExtension18;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension18 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 223, 21);
			ActivityFrame activityFrame;
			VisualDiagnostics.RegisterSourceInfo(activityFrame = new ActivityFrame(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 218, 18);
			Grid grid4;
			VisualDiagnostics.RegisterSourceInfo(grid4 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 98, 14);
			BindingExtension bindingExtension19;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension19 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 230, 17);
			RowDefinition rowDefinition7;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition7 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 233, 22);
			RowDefinition rowDefinition8;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition8 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 235, 22);
			RowDefinition rowDefinition9;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition9 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 237, 22);
			RowDefinition rowDefinition10;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition10 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 239, 22);
			RowDefinition rowDefinition11;
			VisualDiagnostics.RegisterSourceInfo(rowDefinition11 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 241, 22);
			DynamicResourceExtension dynamicResourceExtension13;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension13 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 248, 21);
			DynamicResourceExtension dynamicResourceExtension14;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension14 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 249, 21);
			BindingExtension bindingExtension20;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension20 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 251, 21);
			SharedSettings sharedSettings3;
			VisualDiagnostics.RegisterSourceInfo(sharedSettings3 = SharedSettings.Current, new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 254, 29);
			BindingExtension bindingExtension21;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension21 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 255, 29);
			Translate translate14;
			VisualDiagnostics.RegisterSourceInfo(translate14 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 256, 29);
			LabelSwitch labelSwitch3;
			VisualDiagnostics.RegisterSourceInfo(labelSwitch3 = new LabelSwitch(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 253, 26);
			SharedSettings sharedSettings4;
			VisualDiagnostics.RegisterSourceInfo(sharedSettings4 = SharedSettings.Current, new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 258, 29);
			BindingExtension bindingExtension22;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension22 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 259, 29);
			Translate translate15;
			VisualDiagnostics.RegisterSourceInfo(translate15 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 260, 29);
			LabelSwitch labelSwitch4;
			VisualDiagnostics.RegisterSourceInfo(labelSwitch4 = new LabelSwitch(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 257, 26);
			StackLayout stackLayout3;
			VisualDiagnostics.RegisterSourceInfo(stackLayout3 = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 252, 22);
			Frame frame;
			VisualDiagnostics.RegisterSourceInfo(frame = new Frame(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 244, 18);
			StaticResourceExtension staticResourceExtension4;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension4 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 266, 21);
			BindingExtension bindingExtension23;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension23 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 266, 21);
			Translate translate16;
			VisualDiagnostics.RegisterSourceInfo(translate16 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 268, 50);
			Label label4;
			VisualDiagnostics.RegisterSourceInfo(label4 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 268, 22);
			Translate translate17;
			VisualDiagnostics.RegisterSourceInfo(translate17 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 269, 28);
			Label label5;
			VisualDiagnostics.RegisterSourceInfo(label5 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 269, 22);
			BindingExtension bindingExtension24;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension24 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 272, 25);
			Translate translate18;
			VisualDiagnostics.RegisterSourceInfo(translate18 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 273, 25);
			DynamicResourceExtension dynamicResourceExtension15;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension15 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 274, 25);
			TapGestureRecognizer tapGestureRecognizer4;
			VisualDiagnostics.RegisterSourceInfo(tapGestureRecognizer4 = new TapGestureRecognizer(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 276, 30);
			Label label6;
			VisualDiagnostics.RegisterSourceInfo(label6 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 270, 22);
			StackLayout stackLayout4;
			VisualDiagnostics.RegisterSourceInfo(stackLayout4 = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 264, 18);
			BindingExtension bindingExtension25;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension25 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 285, 21);
			BindingExtension bindingExtension26;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension26 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 286, 21);
			DataTemplate dataTemplate2;
			VisualDiagnostics.RegisterSourceInfo(dataTemplate2 = new DataTemplate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 288, 26);
			SettingsView settingsView;
			VisualDiagnostics.RegisterSourceInfo(settingsView = new SettingsView(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 281, 18);
			BindingExtension bindingExtension27;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension27 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 375, 21);
			BindingExtension bindingExtension28;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension28 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 376, 21);
			ActivityFrame activityFrame2;
			VisualDiagnostics.RegisterSourceInfo(activityFrame2 = new ActivityFrame(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 371, 18);
			BindingExtension bindingExtension29;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension29 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 381, 21);
			BindingExtension bindingExtension30;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension30 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 382, 21);
			BindingExtension bindingExtension31;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension31 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 383, 21);
			Translate translate19;
			VisualDiagnostics.RegisterSourceInfo(translate19 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 384, 21);
			Button button4;
			VisualDiagnostics.RegisterSourceInfo(button4 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 378, 18);
			StaticResourceExtension staticResourceExtension5;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension5 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 386, 36);
			BindingExtension bindingExtension32;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension32 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 386, 36);
			BindingExtension bindingExtension33;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension33 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 388, 40);
			ColumnDefinition columnDefinition7;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition7 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 390, 30);
			ColumnDefinition columnDefinition8;
			VisualDiagnostics.RegisterSourceInfo(columnDefinition8 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 391, 30);
			BindingExtension bindingExtension34;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension34 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 395, 29);
			Translate translate20;
			VisualDiagnostics.RegisterSourceInfo(translate20 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 396, 29);
			Button button5;
			VisualDiagnostics.RegisterSourceInfo(button5 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 393, 26);
			BindingExtension bindingExtension35;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension35 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 399, 29);
			Translate translate21;
			VisualDiagnostics.RegisterSourceInfo(translate21 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 400, 29);
			Button button6;
			VisualDiagnostics.RegisterSourceInfo(button6 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 397, 26);
			Grid grid5;
			VisualDiagnostics.RegisterSourceInfo(grid5 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 388, 22);
			BindingExtension bindingExtension36;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension36 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 405, 25);
			StaticResourceExtension staticResourceExtension6;
			VisualDiagnostics.RegisterSourceInfo(staticResourceExtension6 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 406, 25);
			BindingExtension bindingExtension37;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension37 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 406, 25);
			Translate translate22;
			VisualDiagnostics.RegisterSourceInfo(translate22 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 407, 25);
			Button button7;
			VisualDiagnostics.RegisterSourceInfo(button7 = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 403, 22);
			Grid grid6;
			VisualDiagnostics.RegisterSourceInfo(grid6 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 386, 18);
			BindingExtension bindingExtension38;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension38 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 413, 21);
			DynamicResourceExtension dynamicResourceExtension16;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension16 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 417, 25);
			BindingExtension bindingExtension39;
			VisualDiagnostics.RegisterSourceInfo(bindingExtension39 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 418, 25);
			Translate translate23;
			VisualDiagnostics.RegisterSourceInfo(translate23 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 419, 25);
			DynamicResourceExtension dynamicResourceExtension17;
			VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension17 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 420, 25);
			TapGestureRecognizer tapGestureRecognizer5;
			VisualDiagnostics.RegisterSourceInfo(tapGestureRecognizer5 = new TapGestureRecognizer(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 422, 30);
			Label label7;
			VisualDiagnostics.RegisterSourceInfo(label7 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 415, 22);
			StackLayout stackLayout5;
			VisualDiagnostics.RegisterSourceInfo(stackLayout5 = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 411, 18);
			Grid grid7;
			VisualDiagnostics.RegisterSourceInfo(grid7 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 227, 14);
			ComplexAdView complexAdView;
			VisualDiagnostics.RegisterSourceInfo(complexAdView = new ComplexAdView(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 429, 14);
			Grid grid8;
			VisualDiagnostics.RegisterSourceInfo(grid8 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 93, 10);
			VisualDiagnostics.RegisterSourceInfo(this, new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 2, 2);
			...
			nameScope.RegisterName("lvDTCs", settingsView);
			if (settingsView.StyleId == null)
			{
				settingsView.StyleId = "lvDTCs";
			}
			...
			resourceDictionary.Add("FormatStringConverter", formatStringConverter);
			...
			xamlServiceProvider.Add(typeFromHandle2, new XamlTypeResolver(xmlNamespaceResolver, typeof(DTCv3Page).GetTypeInfo().Assembly));
			...
			xamlServiceProvider2.Add(typeFromHandle4, new XamlTypeResolver(xmlNamespaceResolver2, typeof(DTCv3Page).GetTypeInfo().Assembly));
			...
			xamlServiceProvider3.Add(typeFromHandle6, new XamlTypeResolver(xmlNamespaceResolver3, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider3.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(46, 17)));
			...
			xamlServiceProvider4.Add(typeFromHandle8, new XamlTypeResolver(xmlNamespaceResolver4, typeof(DTCv3Page).GetTypeInfo().Assembly));
			...
			xamlServiceProvider5.Add(typeFromHandle10, new XamlTypeResolver(xmlNamespaceResolver5, typeof(DTCv3Page).GetTypeInfo().Assembly));
			...
			xamlServiceProvider6.Add(typeFromHandle12, new XamlTypeResolver(xmlNamespaceResolver6, typeof(DTCv3Page).GetTypeInfo().Assembly));
			...
			xamlServiceProvider7.Add(typeFromHandle14, new XamlTypeResolver(xmlNamespaceResolver7, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider7.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(62, 17)));
			...
			xamlServiceProvider8.Add(typeFromHandle16, new XamlTypeResolver(xmlNamespaceResolver8, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider8.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(73, 17)));
			...
			xamlServiceProvider9.Add(typeFromHandle18, new XamlTypeResolver(xmlNamespaceResolver9, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider9.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(82, 17)));
			...
			DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_29 <InitializeComponent>_anonXamlCDataTemplate_ = new DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_29();
			...
			xamlServiceProvider10.Add(typeFromHandle20, new XamlTypeResolver(xmlNamespaceResolver10, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider10.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(137, 33)));
			...
			xamlServiceProvider11.Add(typeFromHandle22, new XamlTypeResolver(xmlNamespaceResolver11, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider11.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(140, 33)));
			...
			xamlServiceProvider12.Add(typeFromHandle24, new XamlTypeResolver(xmlNamespaceResolver12, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider12.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(143, 33)));
			...
			xamlServiceProvider13.Add(typeFromHandle26, new XamlTypeResolver(xmlNamespaceResolver13, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider13.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(146, 33)));
			...
			xamlServiceProvider14.Add(typeFromHandle28, new XamlTypeResolver(xmlNamespaceResolver14, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider14.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(147, 33)));
			...
			xamlServiceProvider15.Add(typeFromHandle30, new XamlTypeResolver(xmlNamespaceResolver15, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider15.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(158, 37)));
			...
			xamlServiceProvider16.Add(typeFromHandle32, new XamlTypeResolver(xmlNamespaceResolver16, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider16.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(159, 37)));
			...
			xamlServiceProvider17.Add(typeFromHandle34, new XamlTypeResolver(xmlNamespaceResolver17, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider17.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(160, 37)));
			...
			xamlServiceProvider18.Add(typeFromHandle36, new XamlTypeResolver(xmlNamespaceResolver18, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider18.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(161, 37)));
			...
			xamlServiceProvider19.Add(typeFromHandle38, new XamlTypeResolver(xmlNamespaceResolver19, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider19.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(165, 37)));
			...
			xamlServiceProvider20.Add(typeFromHandle40, new XamlTypeResolver(xmlNamespaceResolver20, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider20.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(166, 37)));
			...
			xamlServiceProvider21.Add(typeFromHandle42, new XamlTypeResolver(xmlNamespaceResolver21, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider21.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(167, 37)));
			...
			xamlServiceProvider22.Add(typeFromHandle44, new XamlTypeResolver(xmlNamespaceResolver22, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider22.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(168, 37)));
			...
			xamlServiceProvider23.Add(typeFromHandle46, new XamlTypeResolver(xmlNamespaceResolver23, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider23.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(178, 58)));
			...
			xamlServiceProvider24.Add(typeFromHandle48, new XamlTypeResolver(xmlNamespaceResolver24, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider24.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(185, 33)));
			...
			xamlServiceProvider25.Add(typeFromHandle50, new XamlTypeResolver(xmlNamespaceResolver25, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider25.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(192, 33)));
			...
			xamlServiceProvider26.Add(typeFromHandle52, new XamlTypeResolver(xmlNamespaceResolver26, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider26.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(196, 33)));
			...
			xamlServiceProvider27.Add(typeFromHandle54, new XamlTypeResolver(xmlNamespaceResolver27, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider27.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(210, 25)));
			...
			xamlServiceProvider28.Add(typeFromHandle56, new XamlTypeResolver(xmlNamespaceResolver28, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider28.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(216, 25)));
			...
			xamlServiceProvider29.Add(typeFromHandle58, new XamlTypeResolver(xmlNamespaceResolver29, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider29.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(248, 21)));
			...
			xamlServiceProvider30.Add(typeFromHandle60, new XamlTypeResolver(xmlNamespaceResolver30, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider30.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(249, 21)));
			...
			xamlServiceProvider31.Add(typeFromHandle62, new XamlTypeResolver(xmlNamespaceResolver31, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider31.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(256, 29)));
			...
			xamlServiceProvider32.Add(typeFromHandle64, new XamlTypeResolver(xmlNamespaceResolver32, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider32.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(260, 29)));
			...
			xamlServiceProvider33.Add(typeFromHandle66, new XamlTypeResolver(xmlNamespaceResolver33, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider33.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(266, 21)));
			...
			xamlServiceProvider34.Add(typeFromHandle68, new XamlTypeResolver(xmlNamespaceResolver34, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider34.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(268, 50)));
			...
			xamlServiceProvider35.Add(typeFromHandle70, new XamlTypeResolver(xmlNamespaceResolver35, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider35.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(269, 28)));
			...
			xamlServiceProvider36.Add(typeFromHandle72, new XamlTypeResolver(xmlNamespaceResolver36, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider36.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(273, 25)));
			...
			xamlServiceProvider37.Add(typeFromHandle74, new XamlTypeResolver(xmlNamespaceResolver37, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider37.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(274, 25)));
			...
			settingsView.SetBinding(VisualElement.IsVisibleProperty, bindingBase25);
			...
			settingsView.SetBinding(SettingsView.ItemsSourceProperty, bindingBase26);
			IDataTemplate dataTemplate4 = dataTemplate2;
			DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30 <InitializeComponent>_anonXamlCDataTemplate_2 = new DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30();
			...
			settingsView.SetValue(SettingsView.ItemTemplateProperty, dataTemplate2);
			grid7.Children.Add(settingsView);
			...
			array40[3] = this;
			object obj60;
			xamlServiceProvider38.Add(typeFromHandle75, obj60 = new SimpleValueTargetProvider(array40, Button.TextProperty, nameScope));
			...
			xamlServiceProvider38.Add(typeFromHandle76, new XamlTypeResolver(xmlNamespaceResolver38, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider38.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(384, 21)));
			...
			array41[0] = bindingExtension32;
			array41[1] = grid6;
			array41[2] = grid7;
			array41[3] = grid8;
			array41[4] = this;
			object obj62;
			xamlServiceProvider39.Add(typeFromHandle77, obj62 = new SimpleValueTargetProvider(array41, typeof(BindingExtension).GetRuntimeProperty("Converter"), nameScope));
			...
			xamlServiceProvider39.Add(typeFromHandle78, new XamlTypeResolver(xmlNamespaceResolver39, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider39.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(386, 36)));
			...
			array42[5] = this;
			object obj64;
			xamlServiceProvider40.Add(typeFromHandle79, obj64 = new SimpleValueTargetProvider(array42, Button.TextProperty, nameScope));
			...
			xamlServiceProvider40.Add(typeFromHandle80, new XamlTypeResolver(xmlNamespaceResolver40, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider40.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(396, 29)));
			...
			array43[5] = this;
			object obj66;
			xamlServiceProvider41.Add(typeFromHandle81, obj66 = new SimpleValueTargetProvider(array43, Button.TextProperty, nameScope));
			...
			xamlServiceProvider41.Add(typeFromHandle82, new XamlTypeResolver(xmlNamespaceResolver41, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider41.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(400, 29)));
			...
			array44[5] = this;
			object obj68;
			xamlServiceProvider42.Add(typeFromHandle83, obj68 = new SimpleValueTargetProvider(array44, typeof(BindingExtension).GetRuntimeProperty("Converter"), nameScope));
			...
			xamlServiceProvider42.Add(typeFromHandle84, new XamlTypeResolver(xmlNamespaceResolver42, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider42.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(406, 25)));
			...
			array45[4] = this;
			object obj70;
			xamlServiceProvider43.Add(typeFromHandle85, obj70 = new SimpleValueTargetProvider(array45, Button.TextProperty, nameScope));
			...
			xamlServiceProvider43.Add(typeFromHandle86, new XamlTypeResolver(xmlNamespaceResolver43, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider43.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(407, 25)));
			...
			array46[4] = this;
			object obj72;
			xamlServiceProvider44.Add(typeFromHandle87, obj72 = new SimpleValueTargetProvider(array46, Label.FontSizeProperty, nameScope));
			...
			xamlServiceProvider44.Add(typeFromHandle88, new XamlTypeResolver(xmlNamespaceResolver44, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider44.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(417, 25)));
			...
			array47[4] = this;
			object obj73;
			xamlServiceProvider45.Add(typeFromHandle89, obj73 = new SimpleValueTargetProvider(array47, Label.TextProperty, nameScope));
			...
			xamlServiceProvider45.Add(typeFromHandle90, new XamlTypeResolver(xmlNamespaceResolver45, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider45.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(419, 25)));
			...
			array48[4] = this;
			object obj75;
			xamlServiceProvider46.Add(typeFromHandle91, obj75 = new SimpleValueTargetProvider(array48, Label.TextColorProperty, nameScope));
			...
			xamlServiceProvider46.Add(typeFromHandle92, new XamlTypeResolver(xmlNamespaceResolver46, typeof(DTCv3Page).GetTypeInfo().Assembly));
			xamlServiceProvider46.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(420, 25)));
		...
		// Token: 0x060034AC RID: 13484 RVA: 0x0025D1FC File Offset: 0x0025B3FC
		private void __InitComponentRuntime()
		{
			Extensions.LoadFromXaml<DTCv3Page>(this, typeof(DTCv3Page));
			...
			this.lvDTCs = NameScopeExtensions.FindByName<SettingsView>(this, "lvDTCs");
		...
		// Token: 0x060034AD RID: 13485 RVA: 0x0025D3A4 File Offset: 0x0025B5A4
		[CompilerGenerated]
		private static ValueTuple<ObservableCollection<IECU>, bool> <InitializeComponent>typedBindingsM__1065(DTCv2Model A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<ObservableCollection<IECU>, bool>(A_0.ECUListToDisplay, true);
		...
		// Token: 0x060034AE RID: 13486 RVA: 0x0025D3D4 File Offset: 0x0025B5D4
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1067(DTCv2Model A_0)
		{
			return A_0;
		}

		// Token: 0x060034AF RID: 13487 RVA: 0x0025D3E4 File Offset: 0x0025B5E4
		[CompilerGenerated]
		private static ValueTuple<bool, bool> <InitializeComponent>typedBindingsM__1076(DTCv2Model A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<bool, bool>(A_0.DisplayAllOrDetectedSelector, true);
		...
		// Token: 0x060034B0 RID: 13488 RVA: 0x0025D414 File Offset: 0x0025B614
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1077(DTCv2Model A_0)
		{
			return A_0;
		}

		// Token: 0x060034B1 RID: 13489 RVA: 0x0025D424 File Offset: 0x0025B624
		[CompilerGenerated]
		private static ValueTuple<bool, bool> <InitializeComponent>typedBindingsM__1078(DTCv2Model A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<bool, bool>(A_0.DisplayAllOrDetectedSelector, true);
		...
		// Token: 0x060034B2 RID: 13490 RVA: 0x0025D454 File Offset: 0x0025B654
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1079(DTCv2Model A_0)
		{
			return A_0;
		}

		// Token: 0x060034B3 RID: 13491 RVA: 0x0025D464 File Offset: 0x0025B664
		[CompilerGenerated]
		private static ValueTuple<bool, bool> <InitializeComponent>typedBindingsM__1080(DTCv2Model A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<bool, bool>(A_0.DisplayDetected, true);
		...
		// Token: 0x060034B4 RID: 13492 RVA: 0x0025D494 File Offset: 0x0025B694
		[CompilerGenerated]
		private static void <InitializeComponent>typedBindingsM__1081(DTCv2Model A_0, bool A_1)
		{
			if (A_0 != null)
			{
				A_0.DisplayDetected = A_1;
		...
		// Token: 0x060034B5 RID: 13493 RVA: 0x0025D4B0 File Offset: 0x0025B6B0
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1082(DTCv2Model A_0)
		{
			return A_0;
		}

		// Token: 0x060034B6 RID: 13494 RVA: 0x0025D4C0 File Offset: 0x0025B6C0
		[CompilerGenerated]
		private static ValueTuple<bool, bool> <InitializeComponent>typedBindingsM__1083(SharedSettings A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<bool, bool>(A_0.HideArchiveDTC, true);
		...
		// Token: 0x060034B7 RID: 13495 RVA: 0x0025D4F0 File Offset: 0x0025B6F0
		[CompilerGenerated]
		private static void <InitializeComponent>typedBindingsM__1084(SharedSettings A_0, bool A_1)
		{
			if (A_0 != null)
			{
				A_0.HideArchiveDTC = A_1;
		...
		// Token: 0x060034B8 RID: 13496 RVA: 0x0025D50C File Offset: 0x0025B70C
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1085(SharedSettings A_0)
		{
			return A_0;
		}

		// Token: 0x060034B9 RID: 13497 RVA: 0x0025D51C File Offset: 0x0025B71C
		[CompilerGenerated]
		private static ValueTuple<bool, bool> <InitializeComponent>typedBindingsM__1086(SharedSettings A_0)
		{
			if (A_0 != null)
			{
				return new ValueTuple<bool, bool>(A_0.HideDTCWithUncomplitedTests, true);
		...
		// Token: 0x060034BA RID: 13498 RVA: 0x0025D54C File Offset: 0x0025B74C
		[CompilerGenerated]
		private static void <InitializeComponent>typedBindingsM__1087(SharedSettings A_0, bool A_1)
		{
			if (A_0 != null)
			{
				A_0.HideDTCWithUncomplitedTests = A_1;
		...
		// Token: 0x060034BB RID: 13499 RVA: 0x0025D568 File Offset: 0x0025B768
		[CompilerGenerated]
		private static object <InitializeComponent>typedBindingsM__1088(SharedSettings A_0)
		{
			return A_0;
		}
		...
		{
			// Token: 0x060034BC RID: 13500 RVA: 0x0025D578 File Offset: 0x0025B778
			void IAsyncStateMachine.MoveNext()
			{
				int num2;
				int num = num2;
				DTCv3Page dtcv3Page = this;
				try
				{
					TaskAwaiter taskAwaiter;
					if (num != 0)
					{
						if (dtcv3Page.Model.IsBusy)
						{
							goto IL_00B2;
						}
						IECU iecu = (sender as VisualElement).BindingContext as IECU;
						taskAwaiter = dtcv3Page.Model.ClearDTCForOneECU(iecu).GetAwaiter();
						if (!taskAwaiter.IsCompleted)
						{
							num2 = 0;
							TaskAwaiter taskAwaiter2 = taskAwaiter;
							this.<>t__builder.AwaitUnsafeOnCompleted<TaskAwaiter, DTCv3Page.<BtnClearECUDTC_Clicked>d__7>(ref taskAwaiter, ref this);
							return;
						}
					}
					else
			...
			// Token: 0x060034BD RID: 13501 RVA: 0x0025D65C File Offset: 0x0025B85C
			[DebuggerHidden]
		...
		{
			// Token: 0x060034BE RID: 13502 RVA: 0x0025D66C File Offset: 0x0025B86C
			void IAsyncStateMachine.MoveNext()
			{
				DTCv3Page dtcv3Page = this;
				try
				{
					dtcv3Page.Model = new DTCv2Model();
					dtcv3Page.BindingContext = dtcv3Page.Model;
				}
				catch (Exception ex)
				{
					this.<>1__state = -2;
			...
			// Token: 0x060034BF RID: 13503 RVA: 0x0025D6D4 File Offset: 0x0025B8D4
			[DebuggerHidden]
			void IAsyncStateMachine.SetStateMachine(IAsyncStateMachine stateMachine)
			{
				this.<>t__builder.SetStateMachine(stateMachine);
		...
		{
			// Token: 0x060034C0 RID: 13504 RVA: 0x0025D6E4 File Offset: 0x0025B8E4
			void IAsyncStateMachine.MoveNext()
			{
				int num2;
				int num = num2;
				...
				try
				{
					...
					if (num != 0)
					{
						...
						if (!taskAwaiter.IsCompleted)
						{
							num2 = 0;
							TaskAwaiter taskAwaiter2 = taskAwaiter;
							this.<>t__builder.AwaitUnsafeOnCompleted<TaskAwaiter, DTCv3Page.<btnToOldStyle_Clicked>d__9>(ref taskAwaiter, ref this);
							return;
						}
					}
					else
					...
					taskAwaiter.GetResult();
					dtcv3Page.btnToOldStyle.IsEnabled = false;
					DTCWizardStartPage dtcwizardStartPage = new DTCWizardStartPage();
					taskAwaiter = dtcv3Page.Navigation.PushAsync(dtcwizardStartPage).GetAwaiter();
					if (!taskAwaiter.IsCompleted)
					{
						num2 = 1;
						TaskAwaiter taskAwaiter2 = taskAwaiter;
					...
					IL_00E5:
					taskAwaiter.GetResult();
					dtcv3Page.btnToOldStyle.IsEnabled = true;
				}
				catch (Exception ex)
				{
					num2 = -2;
			...
			// Token: 0x060034C1 RID: 13505 RVA: 0x0025D828 File Offset: 0x0025BA28
			[DebuggerHidden]
			void IAsyncStateMachine.SetStateMachine(IAsyncStateMachine stateMachine)
			{
				this.<>t__builder.SetStateMachine(stateMachine);
		...
		{
			// Token: 0x060034C2 RID: 13506 RVA: 0x0025D838 File Offset: 0x0025BA38
			public <InitializeComponent>_anonXamlCDataTemplate_29()
			{
			}

			// Token: 0x060034C3 RID: 13507 RVA: 0x0025D84C File Offset: 0x0025BA4C
			internal object LoadDataTemplate()
			{
				BindingExtension bindingExtension;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 127, 37);
				BindingExtension bindingExtension2;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension2 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 128, 37);
				StaticResourceExtension staticResourceExtension;
				VisualDiagnostics.RegisterSourceInfo(staticResourceExtension = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 129, 37);
				BindingExtension bindingExtension3;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension3 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 129, 37);
				LabelSwitch labelSwitch;
				VisualDiagnostics.RegisterSourceInfo(labelSwitch = new LabelSwitch(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 125, 34);
				ViewCell viewCell;
				VisualDiagnostics.RegisterSourceInfo(viewCell = new ViewCell(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 124, 30);
				...
				xmlNamespaceResolver.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
				xmlNamespaceResolver.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
				xamlServiceProvider.Add(typeFromHandle2, new XamlTypeResolver(xmlNamespaceResolver, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_29).GetTypeInfo().Assembly));
				xamlServiceProvider.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(129, 37)));
				object obj2 = markupExtension.ProvideValue(xamlServiceProvider);
			...
			// Token: 0x060034C4 RID: 13508 RVA: 0x0025DC68 File Offset: 0x0025BE68
			[CompilerGenerated]
			private static ValueTuple<bool, bool> <LoadDataTemplate>typedBindingsM__1068(IECU A_0)
			{
				if (A_0 != null)
				{
					return new ValueTuple<bool, bool>(A_0.IsSelected, true);
			...
			// Token: 0x060034C5 RID: 13509 RVA: 0x0025DC98 File Offset: 0x0025BE98
			[CompilerGenerated]
			private static void <LoadDataTemplate>typedBindingsM__1069(IECU A_0, bool A_1)
			{
				if (A_0 != null)
				{
					A_0.IsSelected = A_1;
			...
			// Token: 0x060034C6 RID: 13510 RVA: 0x0025DCB4 File Offset: 0x0025BEB4
			[CompilerGenerated]
			private static object <LoadDataTemplate>typedBindingsM__1070(IECU A_0)
			{
				return A_0;
			}

			// Token: 0x060034C7 RID: 13511 RVA: 0x0025DCC4 File Offset: 0x0025BEC4
			[CompilerGenerated]
			private static ValueTuple<string, bool> <LoadDataTemplate>typedBindingsM__1071(IECU A_0)
			{
				if (A_0 != null)
				{
					return new ValueTuple<string, bool>(A_0.Name, true);
			...
			// Token: 0x060034C8 RID: 13512 RVA: 0x0025DCF4 File Offset: 0x0025BEF4
			[CompilerGenerated]
			private static void <LoadDataTemplate>typedBindingsM__1072(IECU A_0, string A_1)
			{
				if (A_0 != null)
				{
					A_0.Name = A_1;
			...
			// Token: 0x060034C9 RID: 13513 RVA: 0x0025DD10 File Offset: 0x0025BF10
			[CompilerGenerated]
			private static object <LoadDataTemplate>typedBindingsM__1073(IECU A_0)
			{
				return A_0;
			}

			// Token: 0x060034CA RID: 13514 RVA: 0x0025DD20 File Offset: 0x0025BF20
			[CompilerGenerated]
			private static ValueTuple<bool, bool> <LoadDataTemplate>typedBindingsM__1074(IECU A_0)
			{
				if (A_0 != null)
				{
					return new ValueTuple<bool, bool>(A_0.Highlighted, true);
			...
			// Token: 0x060034CB RID: 13515 RVA: 0x0025DD50 File Offset: 0x0025BF50
			[CompilerGenerated]
			private static object <LoadDataTemplate>typedBindingsM__1075(IECU A_0)
			{
				return A_0;
			}
		...
		{
			// Token: 0x060034CC RID: 13516 RVA: 0x0025DD60 File Offset: 0x0025BF60
			public <InitializeComponent>_anonXamlCDataTemplate_30()
			{
			}

			// Token: 0x060034CD RID: 13517 RVA: 0x0025DD74 File Offset: 0x0025BF74
			internal object LoadDataTemplate()
			{
				BindingExtension bindingExtension;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 289, 41);
				BindingExtension bindingExtension2;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension2 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 289, 64);
				StaticResourceExtension staticResourceExtension;
				VisualDiagnostics.RegisterSourceInfo(staticResourceExtension = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 291, 78);
				Translate translate;
				VisualDiagnostics.RegisterSourceInfo(translate = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 291, 78);
				BindingExtension bindingExtension3;
				VisualDiagnostics.RegisterSourceInfo(bindingExtension3 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 291, 78);
				Button button;
				VisualDiagnostics.RegisterSourceInfo(button = new Button(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 291, 38);
				DataTemplate dataTemplate;
				VisualDiagnostics.RegisterSourceInfo(dataTemplate = new DataTemplate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 295, 38);
				Section section;
				VisualDiagnostics.RegisterSourceInfo(section = new Section(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 289, 30);
				NameScope nameScope = new NameScope();
				NameScope.SetNameScope(section, nameScope);
				bindingExtension.Path = "Name";
				BindingBase bindingBase = bindingExtension.ProvideValue(null);
				section.SetBinding(SectionBase.TitleProperty, bindingBase);
				...
				staticResourceExtension.Key = "FormatStringConverter";
				IMarkupExtension markupExtension = staticResourceExtension;
				XamlServiceProvider xamlServiceProvider = new XamlServiceProvider();
				Type typeFromHandle = typeof(IProvideValueTarget);
				int num;
				...
				xmlNamespaceResolver.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
				xmlNamespaceResolver.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
				xamlServiceProvider.Add(typeFromHandle2, new XamlTypeResolver(xmlNamespaceResolver, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30).GetTypeInfo().Assembly));
				xamlServiceProvider.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(291, 78)));
				object obj2 = markupExtension.ProvideValue(xamlServiceProvider);
				bindingExtension3.Converter = obj2;
				translate.Text = "DtcPage_ClearEcuContent";
				...
				array4[2] = section;
				object obj3;
				xamlServiceProvider2.Add(typeFromHandle3, obj3 = new SimpleValueTargetProvider(array4, typeof(BindingExtension).GetRuntimeProperty("ConverterParameter"), nameScope));
				xamlServiceProvider2.Add(typeof(IReferenceProvider), obj3);
				Type typeFromHandle4 = typeof(IXamlTypeResolver);
				XmlNamespaceResolver xmlNamespaceResolver2 = new XmlNamespaceResolver();
				xmlNamespaceResolver2.Add("", "http://xamarin.com/schemas/2014/forms");
				...
				xmlNamespaceResolver2.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
				xmlNamespaceResolver2.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
				xamlServiceProvider2.Add(typeFromHandle4, new XamlTypeResolver(xmlNamespaceResolver2, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30).GetTypeInfo().Assembly));
				xamlServiceProvider2.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(291, 78)));
				object obj4 = markupExtension2.ProvideValue(xamlServiceProvider2);
				bindingExtension3.ConverterParameter = obj4;
				bindingExtension3.Path = "Name";
				BindingBase bindingBase3 = bindingExtension3.ProvideValue(null);
				button.SetBinding(Button.TextProperty, bindingBase3);
				section.SetValue(Section.FooterViewProperty, button);
				IDataTemplate dataTemplate2 = dataTemplate;
				DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31 <LoadDataTemplate>_anonXamlCDataTemplate_ = new DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31();
				int num3;
			...
			[CompilerGenerated]
			private sealed class <LoadDataTemplate>_anonXamlCDataTemplate_31
			{
				// Token: 0x060034CE RID: 13518 RVA: 0x0025E324 File Offset: 0x0025C524
				public <LoadDataTemplate>_anonXamlCDataTemplate_31()
				{
				}

				// Token: 0x060034CF RID: 13519 RVA: 0x0025E338 File Offset: 0x0025C538
				internal object LoadDataTemplate()
				{
					RowDefinition rowDefinition;
					VisualDiagnostics.RegisterSourceInfo(rowDefinition = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 299, 54);
					RowDefinition rowDefinition2;
					VisualDiagnostics.RegisterSourceInfo(rowDefinition2 = new RowDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 300, 54);
					DynamicResourceExtension dynamicResourceExtension;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 307, 57);
					StaticResourceExtension staticResourceExtension;
					VisualDiagnostics.RegisterSourceInfo(staticResourceExtension = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 308, 57);
					BindingExtension bindingExtension;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 308, 57);
					Label label;
					VisualDiagnostics.RegisterSourceInfo(label = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 303, 54);
					DynamicResourceExtension dynamicResourceExtension2;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension2 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 313, 57);
					BindingExtension bindingExtension2;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension2 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 314, 57);
					Translate translate;
					VisualDiagnostics.RegisterSourceInfo(translate = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 315, 57);
					Label label2;
					VisualDiagnostics.RegisterSourceInfo(label2 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 310, 54);
					StackLayout stackLayout;
					VisualDiagnostics.RegisterSourceInfo(stackLayout = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 302, 50);
					ColumnDefinition columnDefinition;
					VisualDiagnostics.RegisterSourceInfo(columnDefinition = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 322, 58);
					ColumnDefinition columnDefinition2;
					VisualDiagnostics.RegisterSourceInfo(columnDefinition2 = new ColumnDefinition(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 323, 58);
					DynamicResourceExtension dynamicResourceExtension3;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension3 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 333, 61);
					StaticResourceExtension staticResourceExtension2;
					VisualDiagnostics.RegisterSourceInfo(staticResourceExtension2 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 334, 61);
					BindingExtension bindingExtension3;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension3 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 334, 61);
					BindingExtension bindingExtension4;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension4 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 335, 61);
					Label label3;
					VisualDiagnostics.RegisterSourceInfo(label3 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 332, 58);
					DynamicResourceExtension dynamicResourceExtension4;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension4 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 339, 61);
					StaticResourceExtension staticResourceExtension3;
					VisualDiagnostics.RegisterSourceInfo(staticResourceExtension3 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 340, 61);
					BindingExtension bindingExtension5;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension5 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 340, 61);
					BindingExtension bindingExtension6;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension6 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 341, 61);
					Label label4;
					VisualDiagnostics.RegisterSourceInfo(label4 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 338, 58);
					DynamicResourceExtension dynamicResourceExtension5;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension5 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 345, 61);
					StaticResourceExtension staticResourceExtension4;
					VisualDiagnostics.RegisterSourceInfo(staticResourceExtension4 = new StaticResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 346, 61);
					BindingExtension bindingExtension7;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension7 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 346, 61);
					BindingExtension bindingExtension8;
					VisualDiagnostics.RegisterSourceInfo(bindingExtension8 = new BindingExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 348, 61);
					Label label5;
					VisualDiagnostics.RegisterSourceInfo(label5 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 343, 58);
					DynamicResourceExtension dynamicResourceExtension6;
					VisualDiagnostics.RegisterSourceInfo(dynamicResourceExtension6 = new DynamicResourceExtension(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 351, 61);
					Translate translate2;
					VisualDiagnostics.RegisterSourceInfo(translate2 = new Translate(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 353, 61);
					Label label6;
					VisualDiagnostics.RegisterSourceInfo(label6 = new Label(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 349, 58);
					StackLayout stackLayout2;
					VisualDiagnostics.RegisterSourceInfo(stackLayout2 = new StackLayout(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 325, 54);
					Grid grid;
					VisualDiagnostics.RegisterSourceInfo(grid = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 320, 50);
					Grid grid2;
					VisualDiagnostics.RegisterSourceInfo(grid2 = new Grid(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 297, 46);
					CustomCell customCell;
					VisualDiagnostics.RegisterSourceInfo(customCell = new CustomCell(), new Uri("DTCv2\\DTCv3Page.xaml" + ";assembly=" + "CarScannerXamarinForms", UriKind.RelativeOrAbsolute), 296, 42);
					NameScope nameScope = new NameScope();
					NameScope.SetNameScope(customCell, nameScope);
					nameScope.RegisterName("labelCode", label);
					if (label.StyleId == null)
					{
						label.StyleId = "labelCode";
					}
					customCell.Tapped += this.root.CustomCell_Tapped;
					...
					xmlNamespaceResolver.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider.Add(typeFromHandle2, new XamlTypeResolver(xmlNamespaceResolver, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(307, 57)));
					...
					xmlNamespaceResolver2.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver2.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider2.Add(typeFromHandle4, new XamlTypeResolver(xmlNamespaceResolver2, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider2.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(308, 57)));
					...
					xmlNamespaceResolver3.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver3.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider3.Add(typeFromHandle6, new XamlTypeResolver(xmlNamespaceResolver3, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider3.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(313, 57)));
					DynamicResource dynamicResource2 = markupExtension3.ProvideValue(xamlServiceProvider3);
					...
					xmlNamespaceResolver4.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver4.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider4.Add(typeFromHandle8, new XamlTypeResolver(xmlNamespaceResolver4, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider4.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(315, 57)));
					object obj6 = markupExtension4.ProvideValue(xamlServiceProvider4);
					label2.Text = obj6;
					...
					xmlNamespaceResolver5.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver5.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider5.Add(typeFromHandle10, new XamlTypeResolver(xmlNamespaceResolver5, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider5.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(333, 61)));
					DynamicResource dynamicResource3 = markupExtension5.ProvideValue(xamlServiceProvider5);
					...
					xmlNamespaceResolver6.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver6.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider6.Add(typeFromHandle12, new XamlTypeResolver(xmlNamespaceResolver6, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider6.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(334, 61)));
					object obj9 = markupExtension6.ProvideValue(xamlServiceProvider6);
					...
					xmlNamespaceResolver7.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver7.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider7.Add(typeFromHandle14, new XamlTypeResolver(xmlNamespaceResolver7, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider7.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(339, 61)));
					DynamicResource dynamicResource4 = markupExtension7.ProvideValue(xamlServiceProvider7);
					...
					xmlNamespaceResolver8.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver8.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider8.Add(typeFromHandle16, new XamlTypeResolver(xmlNamespaceResolver8, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider8.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(340, 61)));
					...
					xmlNamespaceResolver9.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver9.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider9.Add(typeFromHandle18, new XamlTypeResolver(xmlNamespaceResolver9, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider9.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(345, 61)));
					...
					xmlNamespaceResolver10.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver10.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider10.Add(typeFromHandle20, new XamlTypeResolver(xmlNamespaceResolver10, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider10.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(346, 61)));
					...
					xmlNamespaceResolver11.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver11.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider11.Add(typeFromHandle22, new XamlTypeResolver(xmlNamespaceResolver11, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider11.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(351, 61)));
					...
					xmlNamespaceResolver12.Add("syncfusion", "clr-namespace:Syncfusion.XForms.Buttons;assembly=Syncfusion.Buttons.XForms");
					xmlNamespaceResolver12.Add("uc", "clr-namespace:CarScannerXamarinForms.UserControls");
					xamlServiceProvider12.Add(typeFromHandle24, new XamlTypeResolver(xmlNamespaceResolver12, typeof(DTCv3Page.<InitializeComponent>_anonXamlCDataTemplate_30.<LoadDataTemplate>_anonXamlCDataTemplate_31).GetTypeInfo().Assembly));
					xamlServiceProvider12.Add(typeof(IXmlLineInfoProvider), new XmlLineInfoProvider(new XmlLineInfo(353, 61)));
					...
					customCell.SetValue(CustomCell.ContentProperty, grid2);
					return customCell;
				}
